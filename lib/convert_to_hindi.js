...
function vowel_to_hindi(eng, space_for_matra) {
  console.log("Vowel to hindi: ", eng, space_for_matra)
  if (space_for_matra) {
    ...
    switch (state) {
      ...
      case STATE_VOWEL:
        if (is_vowel(chr)) {
          ...
          // Anuswara - not sure if this is the correct rule (i.e. vowel + n|m +
          // consonant)
          if (hin_chr_read != '') {
            hin += vowel_to_hindi(hin_chr_read, space_for_matra);
            hin_chr_read = '';
